...
SELECT column_x, column_y, column_z FROM table_name;
...
SELECT * FROM table_name WHERE column_name BETWEEN X AND Y;
SELECT * FROM table_name WHERE column_name NOT BETWEEN X AND Y;

-- IN statement (When we have multiple OR)
SELECT * FROM table_name WHERE column_name IN (X,Y,Z);

-- The above can be rewritten as
SELECT * FROM table_name WHERE column_name = X OR column_name = Y OR column_name = Z;

-- LIKE/ILIKE Statement 
SELECT * FROM table_name WHERE column_name LIKE 'string%';

-- Example 
SELECT first_name,last_name FROM customer WHERE first_name LIKE 'Jhon%';