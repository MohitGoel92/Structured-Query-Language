...
-- DROP TABLE Statement (RESTRICT will not allow you to drop the table if there are tables dependent on it, CASCADE will 
-- remove the dependent objects alongside the table all at once).
